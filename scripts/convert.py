...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--hpfile",
        type=str,
        default="configs/freevc-s.json",
        help="path to json config file",
    )
    parser.add_argument(
        "--ptfile",
        type=str,
        default="checkpoints/freevc-s.pth",
    ...
    parser.add_argument(
        "--outdir",
        type=str,
        default="output/avid/inter_phone",
        help="path to output dir",
    )
    parser.add_argument(
        "--device", type=str, default="cuda:1", help="device for inference"
    )
    ...
    if hps.model.use_spk:
        ...
        smodel = SpeakerEncoder(
            "speaker_encoder/ckpt/pretrained_bak_5805000.pt", device
        )
